-- Step 5: Apply a synthetic conversion lift to the variant group, to simulate
-- a real UX improvement. Only affects variant users who reached checkout but
-- did not actually purchase (~15% of them are flipped to "converted").
--
-- Save this query's output as a view named `user_funnel_synthetic`.
